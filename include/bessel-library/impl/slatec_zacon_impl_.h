...
/* DECK ZACON */
/* Subroutine */
static inline int slatec_zacon_impl_(double *zr, double *zi, double *fnu, int *kode, int *mr,
                                     ...
                                     double *fnul, double *tol, double *elim, double *alim)
{
    ...
    static double fn;
    static int nn, nw;
    static double yy, c1i, c2i, c1m, as2, c1r, c2r, s1i, s2i, s1r, s2r, cki, arg, ckr, cpn;
    static int iuf;
    static double cyi[2], fmr, csr, azn, sgn;
    static int inu;
    static double bry[3], cyr[2], pti, spn, sti, zni, rzi, ptr, str, znr, rzr, sc1i, sc2i, sc1r,
        sc2r, cscl, cscr;
    ...
    *nz = 0;
    ...
    zni = -(*zi);
    nn = *n;
    slatec_zbinu_impl_(&znr, &zni, fnu, kode, &nn, &yr[1], &yi[1], &nw, rl, fnul, tol, elim, alim);
    if (nw < 0) {
        goto L90;
    }
    /* ----------------------------------------------------------------------- */
