...
/* DECK ZUNK1 */
/* Subroutine */
static inline int slatec_zunk1_impl_(double *zr, double *zi, double *fnu, int *kode, int *mr,
                                     ...
                                     double *elim, double *alim)
{
    ...
    static double fn;
    static int il, kk, nw;
    static double c1i, c2i, c2m, c1r, c2r, s1i, s2i, rs1, s1r, s2r, ang, asc, cki, fnf;
    static int ifn;
    static double ckr;
    static int iuf;
    static double cyi[2], fmr, csr, sgn;
    static int inu;
    static double bry[3], cyr[2], sti, rzi, zri, str, rzr, zrr, aphi, cscl, phii[2], crsc;
