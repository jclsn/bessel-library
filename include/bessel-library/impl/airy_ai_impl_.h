...
*/
static inline tpdfcplx_impl_ airy_ai_impl_(tpdfcplx_impl_ z, int derivative, int scaled)
{
    ...
    /* Compute zairy */
    slatec_zairy_impl_(&x, &y, &derivative, &kode, &air_arr[1], &aii_arr[1], &nz, &ierr);
