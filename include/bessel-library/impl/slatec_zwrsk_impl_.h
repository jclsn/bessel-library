...
/* DECK ZWRSK */
/* Subroutine */
static inline int slatec_zwrsk_impl_(double *zrr, double *zri, double *fnu, int *kode, int *n,
                                     ...
                                     double *tol, double *elim, double *alim)
{
    ...
    /* Local variables */
    static int i_u_, nw;
    static double c1i, c2i, c1r, c2r, act, acw, cti, ctr, pti, sti, ptr, str, ract;
