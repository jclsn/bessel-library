...
/* DECK ZKSCL */
/* Subroutine */
static inline int slatec_zkscl_impl_(double *zrr, double *zri, double *fnu, int *n, double *yr,
                                     ...
                                     double *tol, double *elim)
{
    ...
    static double as, fn;
    static int kk, nn, nw;
    static double s1i, s2i, s1r, s2r, acs, cki, elm, csi, ckr, cyi[2], zdi, csr, cyr[2], zdr, str,
        alas;
    static int idum;
