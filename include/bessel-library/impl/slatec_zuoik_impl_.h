...
/* DECK ZUOIK */
/* Subroutine */
static inline int slatec_zuoik_impl_(double *zr, double *zi, double *fnu, int *kode, int *ikflg,
                                     int *n, double *yr, double *yi, int *nuf, double *tol,
                                     double *elim, double *alim)
{
    ...
    static double ax, ay;
    static int nn, nw;
    static double fnn, gnn, zbi, czi, gnu, zbr, czr, rcz, sti, zni, zri, str, znr, zrr, aarg, aphi,
        argi, phii, argr;
    static int idum;
    static double phir;
    static int init;
