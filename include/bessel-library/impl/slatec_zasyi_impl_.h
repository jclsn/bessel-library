...
/* DECK ZASYI */
/* Subroutine */
static inline int slatec_zasyi_impl_(double *zr, double *zi, double *fnu, int *kode, int *n,
                                     ...
                                     double *elim, double *alim)
{
    ...
    static double az;
    static int nn;
    static double p1i, s2i, p1r, s2r, cki, dki, fdn, arg, aez, arm, ckr, dkr, czi, ezi, sgn;
    static int inu;
    static double raz, czr, ezr, sqk, sti, rzi, tzi, str, rzr, tzr, ak1i, ak1r, cs1i, cs2i, cs1r,
        cs2r, dnu2, rtr1, dfnu, atol;
    static int koded;
