                                        ...
                                        tpdfcplx_impl_ *cyl_i_arr, int scaled)
{
    ...
    if (nu >= 0.0) {
        ...
        if (fabs(floor(fnu) - fnu) < DBL_EPSILON) {
            ...
            slatec_zbesi_impl_(&x, &y, &fnu_m, &kode, &n, &cir[0], &cii[0], &nz, &ierr);
            slatec_flags_zbesi_impl_(ierr, nz);
            ...
            /* Compute zbesk */
            slatec_zbesk_impl_(&x, &y, &fnu_m, &kodek, &n, &ckr[0], &cki[0], &nz, &ierr);
        ...
        if (fabs(floor(fnu) - fnu) < DBL_EPSILON) {
            ...
            /* Compute zbesi */
            slatec_zbesi_impl_(&x, &y, &fnu_m, &kode, &n_m, &cir_m[0], &cii_m[0], &nz, &ierr);
            slatec_flags_zbesi_impl_(ierr, nz);
            ...
            /* Compute zbesk */
            slatec_zbesk_impl_(&x, &y, &fnu_m, &kodek, &n_m, &ckr_m[0], &cki_m[0], &nz, &ierr);
            slatec_flags_zbesk_impl_(ierr, nz);
            ...
            for (int i = 0; i < n_m; i++) {
                ...
                double tmp2 = (fnu_m + (double)tmp1) * M_PI;
                cyl_i_arr[i] =
                    (cir_m[tmp1] + I_IMPL_ * cii_m[tmp1]) +
                    (ckr_m[tmp1] + I_IMPL_ * cki_m[tmp1]) * sin(tmp2) * c_2_pi_e_m_abs_zr;
            }
        ...
        slatec_zbesi_impl_(&x, &y, &fnu_p, &kode, &n_p, &cir_p[0], &cii_p[0], &nz, &ierr);
        slatec_flags_zbesi_impl_(ierr, nz);
