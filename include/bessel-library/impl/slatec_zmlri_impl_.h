...
/* DECK ZMLRI */
/* Subroutine */
static inline int slatec_zmlri_impl_(double *zr, double *zi, double *fnu, int *kode, int *n,
                                     double *yr, double *yi, int *nz, double *tol)
{
    ...
    static double rho;
    static int inu;
    static double pti, raz, sti, rzi, ptr, str, tst, rzr, rho2, flam, fkap, scle, tfnf;
    static int idum;
    static int ifnu;
