...
/* DECK ZSERI */
/* Subroutine */
static inline int slatec_zseri_impl_(double *zr, double *zi, double *fnu, int *kode, int *n,
                                     ...
                                     double *alim)
{
    ...
    static int nw;
    static double wr[2], s1i, s2i, s1r, s2r, cki, acz, arm, ckr, czi, hzi, raz, czr, sti, hzr, rzi,
        str, rzr, ak1i, ak1r, rtr1, dfnu;
    static int idum;
    static double atol;
    static double fnup;
    static int iflag;
