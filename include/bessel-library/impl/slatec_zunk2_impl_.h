...
/* DECK ZUNK2 */
/* Subroutine */
static inline int slatec_zunk2_impl_(double *zr, double *zi, double *fnu, int *kode, int *mr,
                                     ...
                                     double *elim, double *alim)
{
    ...
    static double yy, c1i, c2i, c2m, c1r, c2r, s1i, s2i, rs1, s1r, s2r, aii, ang, asc, car, cki,
        fnf;
    static int nai;
    static double air;
    static int ifn;
    ...
    static int inu;
    static double bry[3], cyr[2], pti, sti, zbr, zni, rzi, ptr, zri, str, znr, rzr, zrr, daii, aarg;
    static int ndai;
    ...
    static double zeta1i[2], zeta2i[2], zet1di, zet2di, zeta1r[2], zeta2r[2], zet1dr, zet2dr,
        asumdi, bsumdi, asumdr, bsumdr;
