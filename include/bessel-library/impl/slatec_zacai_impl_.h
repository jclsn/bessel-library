...
/* DECK ZACAI */
/* Subroutine */
static inline int slatec_zacai_impl_(double *zr, double *zi, double *fnu, int *kode, int *mr,
...
L20:
    ...
    /* ----------------------------------------------------------------------- */
    slatec_zasyi_impl_(&znr, &zni, fnu, kode, &nn, &yr[1], &yi[1], &nw, rl, tol, elim, alim);
    if (nw < 0) {
        goto L80;
    }
    goto L40;
