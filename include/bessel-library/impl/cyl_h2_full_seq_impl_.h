                                         ...
                                         tpdfcplx_impl_ *cyl_h2_arr, int scaled)
{
    ...
    if (cabs(z) < DBL_EPSILON) {
        ...
        /* Compute zbesh */
        slatec_zbesh_impl_(&x, &y, &fnu, &kode, &m, &n, &ch2r[0], &ch2i[0], &nz, &ierr);
        ...
        slatec_zbesh_impl_(&x, &y, &fnu_m, &kode, &m, &n, &ch2r_m[0], &ch2i_m[0], &nz, &ierr);
        slatec_flags_zbesh_impl_(ierr, nz);
        ...
        for (int i = 0; i < n; i++) {
            ...
            /* Eq. (9.1.6) of Ref. [1] */
            cyl_h2_arr[i] = (ch2r_m[tmp1] + I_IMPL_ * ch2i_m[tmp1]) * cexp(-I_IMPL_ * tmp2);
        }
        ...
        /* Compute zbesh */
        slatec_zbesh_impl_(&x, &y, &fnu_m, &kode, &m, &n_m, &ch2r_m[0], &ch2i_m[0], &nz, &ierr);
        slatec_flags_zbesh_impl_(ierr, nz);
        ...
        slatec_zbesh_impl_(&x, &y, &fnu_p, &kode, &m, &n_p, &ch2r_p[0], &ch2i_p[0], &nz, &ierr);
        slatec_flags_zbesh_impl_(ierr, nz);
