...
/* DECK ZBESY */
/* Subroutine */
static inline int slatec_zbesy_impl_(double *zr, double *zi, double *fnu, int *kode, int *n,
                                     ...
                                     double *cwrki, int *ierr)
{
    ...
    static int nz1, nz2;
    static double exi, r1m5, exr, sti, tay, tol, str, hcii, elim, atol, rtol, ascle;
