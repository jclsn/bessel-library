...
/* DECK ZBIRY */
/* Subroutine */
static inline int slatec_zbiry_impl_(double *zr, double *zi, int *id, int *kode, double *bir,
                                     double *bii, int *ierr)
{
    /* Initialized data */
    static int c_u_1 = 1;
    ...
    static int nz;
    static double s1i, az3, s2i, s1r, s2r, z3i, z3r, eaa, fid, dig, cyi[3], fmr, r1m5, fnu, cyr[3],
        tol, sti, str, sfac, alim, elim, csqi;
