...
/* DECK ZAIRY */
/* Subroutine */
static inline int slatec_zairy_impl_(double *zr, double *zi, int *id, int *kode, double *air,
                                     double *aii, int *nz, int *ierr)
{
    ...
    static double rl;
    static int mr;
    static double s1i, az3, s2i, s1r, s2r, z3i, z3r, dig, fid, cyi[3], r1m5, fnu, cyr[3], tol, sti,
        ptr, str, sfac, alim, elim, alaz, csqi;
